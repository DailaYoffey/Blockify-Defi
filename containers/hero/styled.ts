...
export const Backmountain = styled.div<BackmountainProps>`
  ...
  z-index: 2;
`;
export const Backmountain1 = styled.div<BackmountainProps>`
  position: fixed;
  bottom: 0;
  width: 100%;
  transform: ${(props: BackmountainProps) => `translate3d(0px, ${props.transform}px, 0px)`};
  height: 54vh;
  background-attachment: fixed;
  background: url(/assets/images/backmountain1.png) no-repeat;
  background-position: top center;
  background-size: cover;
  z-index: 2;
...
`;
export const Backmountain2 = styled.div<BackmountainProps>`
  position: fixed;
  bottom: 0;
  width: 100%;
  transform: ${(props: BackmountainProps) => `translate3d(0px, ${props.transform}px, 0px)`};
  height:48vh;
  background-attachment: fixed;
  background: url(/assets/images/backmountain2.png) no-repeat;
  background-position: top center;
  background-size: cover;
  z-index: 2;
`;
export const Backmountain3 = styled.div<BackmountainProps>`
  position: fixed;
  bottom: 0;
  width: 100%;
  transform: ${(props: BackmountainProps) => `translate3d(0px, ${props.transform}px, 0px)`};
  height: 60vh;
  background-attachment: fixed;
  background: url(/assets/images/backmountain3.png) no-repeat;
  background-position: top center;
  background-size: cover;
  z-index: 2;
`;
export const Backmountain4 = styled.div<BackmountainProps>`
  position: fixed;
  bottom: 0;
  width: 100%;
  transform: ${(props: BackmountainProps) => `translate3d(0px, ${props.transform}px, 0px)`};
  height: 62vh;
  background-attachment: fixed;
  background: url(/assets/images/backmountain4.png) no-repeat;
  background-position: top center;
  background-size: cover;
  z-index: 2;
`;